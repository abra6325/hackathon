...
from .events import Event, EventHolder
...
class Renderable(YikObject):
    ...
    def __init__(self, parent, screen_position: Union[Dimension, tuple] = Dimension(0, 0), size: Dimension = Dimension(0, 0), z_index: int = 0, *args, **kwargs):
...
class WindowGLTkCanvas(OpenGLFrame, YikObject):
    ...
    def initgl(self):
        ...
        self.parent.call_event_listener(Event.Initialization.PostLoadEvent)
...
class WindowGLTk(YikObject, EventHolder):
