...
class World(CanTick, ScriptableObject, EventHolder):
    n = 0

    _parent_whitelist = (WindowGLTk,)
    _preserved_fields = {"_tick", "__tick"}

    def __init__(self, parent, tps=128, precise=True):
        CanTick.__init__(self, parent, routine_include=True, routine_frequency=tps, precise=precise)
