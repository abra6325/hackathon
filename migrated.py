...
app = yik.ApplicationObject("Natural Selection")

view = yik.WindowGLTk(app)
world = yik.World(view, tps=128)
...
#     def __init__(self, world, size, x, y, path):
#         self.nearest = None
...
# b2 = MovableIndividual(world, 10, 0, 0, path="texture.png")
# b2 = MovableIndividual(ctx, 10,  random.randint(0,799),random.randint(0,799))
# b2 = MovableIndividual(ctx, 10,  random.randint(0,799),random.randint(0,799))
# b1 = Blob(world, 10, random.randint(0,799),random.randint(0,799), 10)
# b1 = Blob(ctx, 10, random.randint(0,799),random.randint(0,799), 10)
# b1 = Blob(ctx, 10, random.randint(0,799),random.randint(0,799), 10)

class Apple(yik.Particle):
